...
Repozytorium zawiera raporty i materiały przygotowane w ramach ćwiczeń realizowanych na przedmiocie **Inteligencja Biznesowa** na AGH w Krakowie. Projekty obejmują zagadnienia związane z Power BI, SQL, modelowaniem danych, architekturą OLAP, Data Lakehouse oraz podstawami uczenia maszynowego. 

## Zawartość repozytorium

### 1. `databricks-lakehouse-customer-analytics.pdf`
...
### 3. `powerbi-sales-and-nyc-collisions.pdf`
...
### 4. `sql-oltp-to-olap-powerbi.docx`
...
- Microsoft Power BI i dashboardy interaktywne
- Power Query i transformacje danych
- Miary DAX i KPI 
- SQL, OLTP, OLAP i schemat gwiazdy
- Data Lakehouse i Databricks 
- Automatyzacja pipeline’ów danych 
- Elementy modelowania predykcyjnego ML 

# Business Intelligence 

This repository contains reports and materials prepared as part of lab exercises for the **Business Intelligence** course at AGH University of Science and Technology in Kraków. The projects cover topics related to Power BI, SQL, data modeling, OLAP architectures, Data Lakehouse, and basic machine learning.
...
- Microsoft Power BI and interactive dashboards  
- Power Query and data transformations  
- DAX measures and KPIs  
- SQL, OLTP, OLAP and star schema design  
- Data Lakehouse and Databricks  
- Automation of data pipelines  
- Elements of predictive ML modeling  
